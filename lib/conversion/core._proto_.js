...
Primitive.prototype.cover = function(){
	return "suffixed";
};
...
Precision.prototype.treat = function(){
	return Primitive.prototype.treat.call(this)+ " %";
};

Precision.prototype.cover = function(){
	return Primitive.prototype.cover.call(this)+ " %";
};
