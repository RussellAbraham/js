...
(function (global) {
	...
	/* Primitive share prototypes of Ctor */	
	function Primitive(obj) {
		Ctor.call(this, obj);
		this.name = obj;
	};

	Primitive.prototype = Object.create(Ctor.prototype, {
		constructor: {
			configurable: true,
			enumerable: true,
			value: Primitive,
	...
	/* Message share prototypes of Ctor */
...
function parso(obj){
	return JSON.parse(evaluator(obj).name.split('>')[2].split('<')[0])
}
