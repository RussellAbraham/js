...
(function (global) {
	...
	/* using this constructors closure as the scope for libraries to share properties, accessors and mutators */
	...
	var Temperature = (global.Converter().Temperature = function (obj) {
		Ctor.call(this, obj);
		this.name = obj;
	});
	...
	global.temperatureConverter = new Temperature("TemperatureConverter");
