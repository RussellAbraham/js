(function(global){
	...
	Node.prototype = Object.create(Constructor.prototype, {
		constructor : {			
			configurable : true,
			enumerable : true,
			value : Node,
	...
	var SinglyLinkedList = global.SinglyLinkedList = function () {
		this.head = null;
		this.tail = null;
		this.length = 0;
	};

	SinglyLinkedList.prototype = Object.create(Constructor.prototype, {
		constructor : {			
			configurable : true,
			enumerable : true,
